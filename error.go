...
// ErrInvalidHash is returned if the provided hash is not in the
// correct format.
...
// ErrInvalidHasherConfiguration returns if the hasher
// configuration contains invalid parameters
...
// ErrUnknownSetting returns if a setting string contains a key
// that is unknown
